...
const AiModal = () => {
    const {aiModalState, closeAiModal} = useModalStore();

    if(!aiModalState) return null;

    return (
        <div data-slot="dialog-portal"
        >
          <div
        data-state={aiModalState ? "open" : "closed"}
        ...
        onClick={closeAiModal} // Added onClick event to close modal
      >
        <div
