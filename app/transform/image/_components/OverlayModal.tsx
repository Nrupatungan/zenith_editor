...
const OverlayModal = () => {
    const {overlayModalState, closeOverlayModal} = useModalStore();

    if(!overlayModalState) return null;

    return (
        <div data-slot="dialog-portal"
        >
          <div
        data-state={overlayModalState ? "open" : "closed"}
        ...
        onClick={closeOverlayModal} // Added onClick event to close modal
      >
        <div
